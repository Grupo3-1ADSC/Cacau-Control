...
Insert into Usuarios (Nome, CPF, Email, Senha, Fkcliente)
values ('João Rosa', 589325416-89, 'joao123@hotmail.com', 125874, 4);

Insert into Usuarios (Nome, CPF, Email, Senha, Fkcliente)
values ('Jefferson Pires', 123479620-25, 'jefferson.pires38@gmail.com', 'jeff853', 2);

Insert into Usuarios (Nome, CPF, Email, Senha, Fkcliente)
values ('Ayrton Cleyton', 236541897-65, 'cleyton453@indicocacau.com', 'cacauindico895', 1);

Insert into Usuarios (Nome, CPF, Email, Senha, Fkcliente)
values ('Cleide Pereira', 87420136589-45, 'cleide.pere452@outlook.com', 'pereira873', 3);

Insert into Usuarios (Nome, CPF, Email, Senha, Fkcliente)
values ('Conceição silva', 02136846-87, 'conceisil@outlook.com', 'conceicaosilsil', 3);
